...
import {
   getAdminProducts,
   getSellerProducts,
} from '../../store/actions/sellerProductsActions';
...
const AdminProductsList = () => {
   ...
   const adminProductsState = useSelector((state) => state.getAdminProducts);
   const { loading, products } = adminProductsState;
   ...
   useEffect(() => {
      if (!seller?.isSShopAdmin) {
         router.push('/loginseller?redirect=adminproducts');
      }
   ...
   return (
      <>
         ...
         <div className="admin-products-list section-small">
                        ...
                        <div key={product._id} className="box my-0">
                           ...
                           <div className="details">
                              ...
                              <div className="col-two p-0">
                                 <h4># {product.price}</h4>
                                 <Link
                                    href="/adminproduct/[id]"
                                    as={`/adminproduct/${product._id}`}
                                 >
